        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-6 items-center gap-12 lg:gap-16 py-8 lg:py-8 ">
          <div className="lg:col-span-3 z-10 text-center lg:text-left">
            ...
            <div className="max-w-3xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight mb-6 text-left leading-snug">
            ...
            <Button
              asChild
              size="lg"
              className="inline-flex items-center gap-2.5 h-12 px-8 bg-[#0078D4] hover:bg-indigo-700 text-white font-bold text-base rounded-lg shadow-xl shadow-indigo-500/20 hover:shadow-indigo-500/30 transition-all duration-300 transform hover:-translate-y-0.5"
            >
          ...
          <div className="lg:col-span-3 relative flex justify-center lg:justify-end">
            ...
            <div className="absolute -bottom-10 -left-10 w-72 h-96 bg-indigo-100 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
            <img
              src={illustrationUrl}
              alt="Team collaborating on business growth"
              className="relative w-full max-w-md lg:max-w-none drop-shadow-2xl h-96"
            />
          </div>
        </div>
      </div>
