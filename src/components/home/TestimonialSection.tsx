...
const initialTestimonials = [
  ...
  },
  {
    ...
    rating: 5,
    content:
      "Silver Talent has exceeded all expectations with their professionalism, prompt communication, and quality of candidates. They made the hiring process smooth and hassle-free.",
    name: "GM HR",
  ...
  },
  {
    ...
    rating: 5,
    content:
      "I’d like to take a moment to acknowledge and appreciate the excellent work you do. You’ve been a dedicated, reliable, and approachable recruitment partner.",
    name: "—",
  ...
  },
  {
    ...
    rating: 5,
    content:
      "I've worked closely with the HR team at Silver Talent, and they’ve consistently supported us in successfully filling several niche roles.",
    name: "Manager HR",
  ...
  },
  {
    ...
    rating: 5,
    content:
      "Silver Talent has consistently demonstrated genuine commitment to delivering talent across all levels. Their proactive involvement in understanding our requirements is truly commendable.",
        ...
        <div className="relative max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-start">
            {initialTestimonials.map((testimonial) => (
              <div
                key={testimonial.id}
                className={`group bg-white rounded-2xl shadow-lg p-4 border border-blue-500 ${hoverBgColor} ${hoverBorderColor} h-full flex flex-col transition-all duration-300 ease-in-out cursor-pointer`}
              >
